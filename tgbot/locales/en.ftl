...
welcome-to-base-store =
    ...
    Здесь вы можете обменять ваши <i><b>base</b></i> 💎 на скидку при слудующей покупке.
    ...
    На вашем счету: <b>{ $bases } <i>base</i></b>

    Получайте <i><b>base</b></i> за покупки в <b>Books_base</b>
