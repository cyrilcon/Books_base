...
command-my-account = 🙋🏼 Ваш аккаунт в Books_base

command-premium = ⚜️ Получить PREMIUM

command-search = 🔍 Поиск книги

command-booking = 📝 Заказать книгу

command-cancel-booking = 🚫 Отменить заказ

command-base-store = 💎 Магазин скидок

command-share-base = 🤝🏻 Поделиться 💎 с другом

command-support = ⚠️ Техподдержка

command-start = 🔄 Перезапустить бота

command-help = ℹ️ Справка

command-admin = 🧑🏼‍💼 Команды для админа