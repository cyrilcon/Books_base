...
Revision ID: 7435f526b124
Revises: 
Create Date: 2024-04-03 11:52:01.382700
...
def upgrade() -> None:
    ...
    op.create_table(
        "premium",
        sa.Column("id_premium", sa.Integer(), autoincrement=False, nullable=False),
