share-base =
    ...
    <i>(Имя пользователя начинается с символа "<code>@</code>", например: <b>@durov</b>. Ссылка может выглядеть вот так: t.me/durov)</i>

share-base-error-invalid-username =
    Ваше сообщение не содержит <i><b>имя пользователя</b></i> или <i><b>ссылку</b></i> на него!!
...
share-base-error-user-not-found =
    Пользователь <b>@{ $username }</b> ещё не посещал наш магазин!!
...
share-base-error-insufficient-funds = У вас недостаточно base, чтобы отправить их @{ $username }!!

share-base-error-general =
    Произошла ошибка при отправке <i><b>base</b></i>!!
