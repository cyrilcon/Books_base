...
saturday-action = Субботняя акция

saturday-error = Сегодня не суббота!!

saturday-error-user-has-premium = Вам не доступна субботняя акция, так как у вас действует статус <b>{ -books-base-premium }</b> ⚜️
