...
payment-book-success =
    ...
    На ваш счёт начислено { $base } <i>base</i> 💎

    <i>(<a href="https://telegra.ph/Books-base-Payment-and-Refund-Policy-RU-10-15#🔴-Условия-возврата">Условия возврата</a>)</i>
...
payment-book-canceled = Вы отменили покупку книги
...
payment-premium-canceled = Вы отменили покупку { -books-base-premium } ⚜️

payment-premium-unprocessed-messages = Оплатите <b>{ -books-base-premium }</b> ⚜️ или отмените оплату
...
payment-set-error-user-already-has-this-book = У вас уже есть книги из этого набора!!
...
payment-set-canceled = Вы отменили покупку набора из трёх книг

payment-set-unprocessed-messages = Оплатите набор из трёх книг или отмените оплату

payment-check =
    <i>Ваш ID транзакции:</i>
    <code>{ $id_payment }</code>
